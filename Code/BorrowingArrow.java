...
public class BorrowingArrow {
    ...
    public void borrowingArrowSelection() {
        ...
        while (true) {
            ...
            System.out.println("    ~ Straw men cannot be used more than 3 times\n");

            System.out.println("2 [Advanced version] Dynamic Arrow Borrowing");
            System.out.println("    ~ Number of arrow waves is random");
            System.out.println("    ~ Straw men cannot be used more than 2 times");
            ...
            switch (opt) {
                ...
                case "1":
                    ...
                    System.out.println("Enter to go back to \"Borrowing Arrows\" page");
                    option.nextLine();
                    break;
    ...
    public void computeBorrowingArrow(int mode) { //mode=1: Normal version; mode=2: Advanced version
        ...
        System.out.println("Enter Number of straw men < 100 [-1 to exit]");
        ...
        if (mode == 2) {
            ...
            if (dirArrow[0] == null) {
                ...
                if (countAllUsedUp == 4) {
                    ...
                    System.out.println(" --->> Arrows are too less & cant be capture <<---");
                }
